...
On all viewport sizes, animate the search bar from `y: -15` with opacity using a `380/30` spring; when closing, fade it out without moving it. Let the surrounding sticky-header space follow with `layout`.
